...
void iaPlaying(){
    ...
    while (!gameOver())
    {
        ...
        if (gameOver()) // Vérifier si le jeu est terminé après le coup du joueur
            break;
        
        int iaChoice;
        do 
        {
            iaChoice = rand() % 9 + 1; // Générer un nombre aléatoire entre 1 et 9
        }
        while (iaChoice == choix || (iaChoice == 1 && case1 != '1') || (iaChoice == 2 && case2 != '2') ||
                 (iaChoice == 3 && case3 != '3') || (iaChoice == 4 && case4 != '4') || 
                 (iaChoice == 5 && case5 != '5') || (iaChoice == 6 && case6 != '6') ||
                 (iaChoice == 7 && case7 != '7') || (iaChoice == 8 && case8 != '8') ||
                 (iaChoice == 9 && case9 != '9')); // Vérifier si la case est déjà occupée
        switch (iaChoice)
        {
            case 1:
                case1 = 'X';
